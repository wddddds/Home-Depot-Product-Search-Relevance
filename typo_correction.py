def check_spell(query):
    ...
    '''
    this function correct all typos in search terms, the dictionary is generated by google search correction system
    :param query: the search term
    :return: corrected search term
    '''
    ...
    if query in spell_check_dict:
        # print 'query', query, '=>', spell_check_dict[query]
        return spell_check_dict[query]
    else:
        return query
